...
- 실제 자료 버전(real-…)이나 실제 수치를 쓰지 않는다. 시연용 합성(demo-001) 기준이다
사다리 예시 5개는 2026-09-19에 실제 화면에서 확인한 문구를 옮긴 것이다.
"""
...
LANDING = LandingContent(
    ...
    hero_note="화면의 모든 수치는 시연용 합성 수치입니다 · 자료 버전 demo-001",
    steps=(
    ...
    ladder_intro="쓸 수 있는 가장 좁은 범위부터 씁니다. 못 쓰면 한 칸 넓히고, 넓힌 이유를 화면에 밝힙니다.",
    ladder_cases=(
        LadderCase(
        ...
        LadderCase(
            "taebaek", "강원 태백시", "sido",
            "강원특별자치도 범위 참고 — 선택 지역의 진단이 아님",
            "선택한 강원특별자치도 태백시의 근거 자료가 없어 강원특별자치도 자료를 보여 줍니다. "
            "넓은 범위의 참고자료이며 선택한 지역의 소비를 진단한 결과가 아닙니다.",
        ),
        LadderCase(
            "jongno", "서울 종로구", "sido",
            "서울특별시 범위 참고 — 선택 지역의 진단이 아님",
            "선택한 서울특별시 종로구의 자료는 표본이 부족해(6개월 중 계산 가능한 달이 3개월로 기준 4개월에 못 미침) "
            "서울특별시 자료를 보여 줍니다. 넓은 범위의 참고자료이며 선택한 지역의 소비를 진단한 결과가 아닙니다.",
        ),
        LadderCase(
            "jejusi", "제주 제주시", "sido",
            "제주특별자치도 범위 참고 — 선택 지역의 진단이 아님",
            "선택한 제주특별자치도 제주시의 자료는 사용할 수 없어(사유: 가맹점 소재지 기준이 확인되지 않아 "
            "시군구 비교에 사용할 수 없는 자료) 제주특별자치도 자료를 보여 줍니다. "
            "넓은 범위의 참고자료이며 선택한 지역의 소비를 진단한 결과가 아닙니다.",
        ),
        LadderCase(
            "sejong", "세종특별자치시", "national",
            "전국 참고 — 특정 지역의 진단이 아님",
            "선택한 세종특별자치시의 근거 자료가 없어 전국 참고 자료를 보여 줍니다. "
    ...
    closing_lead=(
        ...
        "근거 확인부터 Markdown 내보내기까지 직접 따라가 보세요."
    ),
