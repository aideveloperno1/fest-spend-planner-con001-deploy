...
브라우저에서 `http://127.0.0.1:8000`을 엽니다. 화면 위쪽에 **"시연용 합성 수치 · demo-hierarchy-002"** 표시가 보이면 지역 계층 합성자료로 동작 중입니다. 지역 선택지는 2026년 6월 기준이며, 인천의 7월 개편 전 구역을 포함합니다. 아래의 과거 화면 캡처는 이전 데이터 버전의 예시로, 현재 수치와 다를 수 있습니다.
